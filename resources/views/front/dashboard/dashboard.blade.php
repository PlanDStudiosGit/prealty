       ...
       @include('front.dashboard.includes.sidenavbar')
        ...
        <main>
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12  align-self-center">
                        <div class="sub-header mt-3 py-3 px-3 align-self-center d-sm-flex w-100 rounded">
                            <div class="w-sm-100 mr-auto"><h4 class="mb-0">Welcome {{ucwords(Auth::user()->name)}}</h4></div>
                ...
                <p >View properties by clicking the Search Properties menu button or you can view properties you have invested in by going to my properties.</p>
                    ...
                    <div class="row">
                            ...
                            @php
                                ...
                                $remaining_amount=$initail_investment-@$current_investment;
                            @endphp
              
                        <div class="box">
                            <p>INITIAL INVESTMENT: ${{$initail_investment}}</p>
                            <p>CURRENTLY INVESTED: ${{@$current_investment}}</p>
